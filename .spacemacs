...
;; run tern server from
;; c:\Users\jwojciechowski\AppData\Roaming\npm\tern.cmd
;; then use tern-use-server provide a port and server name should be empty
;; done
...
(custom-set-variables
 ...
 '(org-agenda-files (quote ("c:/Users/jwojciechowski/notepad.org")))
 '(org-modules
   (quote
    (org-bbdb org-bibtex org-docview org-gnus org-info org-irc org-mhe org-rmail org-w3m org-drill)))
 '(package-selected-packages
   (quote
    (company evil-leader evil use-package bind-key dash)))
